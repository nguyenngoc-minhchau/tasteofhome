(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_25b5c355._.js", {
        ...
        case "UPDATE_QUANTITY":
            {
                const updatedItems = state.items.map((item)=>item.id === action.payload.id ? {
                        ...item,
                        quantity: Math.max(0, Math.min(action.payload.quantity, item.stock))
...
_s(CartProvider, "6ossOFFrGyJPGb+fMIcKyujDkdU=");
_c = CartProvider;
function useCart() {
    _s1();
...
//# sourceMappingURL=_25b5c355._.js.map