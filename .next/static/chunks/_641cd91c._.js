...
function SearchFilters(param) {
    let { categories, countries, tags, selectedCategory, onCategoryChange, priceRange, onPriceRangeChange, selectedCountries, onCountriesChange, selectedTags, onTagsChange, isOrganic, onOrganicChange, isArtisanal, onArtisanalChange, onClearAll } = param;
    _s();
...
_s(SearchFilters, "ZNAWeaZQYLq8CaNpRDuIys4fNtU=");
_c = SearchFilters;
var _c;
...
function HomePage() {
    ...
    const [isArtisanal, setIsArtisanal] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const { state: cartState, dispatch: cartDispatch } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$contexts$2f$cart$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCart"])();
    const filteredProducts = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "HomePage.useMemo[filteredProducts]": ()=>{
            return products.filter({
                "HomePage.useMemo[filteredProducts]": (product)=>{
                    // Search query filter
                    ...
                    if (selectedTags.length > 0 && !selectedTags.some({
                        "HomePage.useMemo[filteredProducts]": (tag)=>product.tags.includes(tag)
                    }["HomePage.useMemo[filteredProducts]"])) {
                        return false;
                    }
                    // Organic filter
...
_s(HomePage, "So8bGJwkdA4dQQy9V/9jjjK03RM=", false, function() {
    return [
...
//# sourceMappingURL=_641cd91c._.js.map