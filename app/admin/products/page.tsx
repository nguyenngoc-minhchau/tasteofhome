...
import { Search, Plus, Edit, Trash2, Eye, Package, Star, MoreHorizontal } from "lucide-react"
...
export default function ProductManagementPage() {
  ...
  const stats = {
    ...
    activeProducts: adminProducts.filter((p) => p.status === "active").length,
    lowStockProducts: adminProducts.filter((p) => p.status === "low-stock").length,
    outOfStockProducts: adminProducts.filter((p) => p.status === "out-of-stock").length,
  }
