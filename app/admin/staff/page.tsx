                                ...
                                <TabsContent value="performance" className="space-y-4">
                                  <div className="grid grid-cols-2 gap-4">
                                    <div>
                                      ...
                                      <div className="text-2xl font-bold">{member.performance.ordersProcessed}</div>
                                    </div>
                                    <div>
                                  ...
                                  <div>
                                    <Label>Tasks Completed: {member.performance.tasksCompleted}</Label>
                                    <Progress value={member.performance.tasksCompleted} className="mt-1" />
                                  </div>
                                  <div>
                                    <Label>Attendance: {member.performance.attendance}%</Label>
                                    <Progress value={member.performance.attendance} className="mt-1" />
                                  </div>
                                </TabsContent>
                    ...
                    <div key={member.id} className="border rounded-lg p-6">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                        <div className="text-center">
                          <div className="text-2xl font-bold text-blue-600">{member.performance.ordersProcessed}</div>
                        ...
                        <div className="text-center">
                          <div className="text-2xl font-bold text-purple-600">{member.performance.attendance}%</div>
                      ...
                      <div className="mt-4 space-y-2">
                        <div>
                          <div className="flex justify-between text-sm mb-1">
                            ...
                            <span>{member.performance.tasksCompleted}%</span>
                          </div>
                          <Progress value={member.performance.tasksCompleted} />
                        </div>
                        <div>
                          <div className="flex justify-between text-sm mb-1">
                          ...
                          <Progress value={member.performance.attendance} />
                        </div>
                      </div>
                    </div>
                  ))}
