    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <Link href="/manager">
            <Button>Back to Manager Dashboard</Button>
          </Link>
        </div>
      </div>
    )
        ...
        <header className="border-b">
          <div className="container mx-auto px-4 py-4">
            <div className="flex items-center justify-between">
              <Link href="/manager/orders" className="flex items-center gap-2 text-lg font-semibold hover:text-primary">
            ...
            <Card>
              ...
              <CardContent className="space-y-6">
                ...
                <div className="flex gap-3">
                  <Link href="/manager/orders" className="flex-1">
                    <Button className="w-full">Back to Orders Management</Button>
                  </Link>
                  <Link href={`/manager/orders/${order.id}`} className="flex-1">
